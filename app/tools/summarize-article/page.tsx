  ...
  return (
    <div className="min-h-screen bg-ink-50">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-lg text-ink-500 mb-10">Paste a URL. WizeMory AI reads the full article — not just the headline — and extracts what actually matters.</p>
