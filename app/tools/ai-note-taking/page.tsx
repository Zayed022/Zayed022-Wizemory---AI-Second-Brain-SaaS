...
export const metadata: Metadata = {
  title: 'AI Note Taking App — Smarter Notes That Remember | WizeMory',
  description: 'WizeMory is the AI note taking app that automatically summarises, tags, and connects everything you save. Zero manual organisation.',
  alternates: { canonical: 'https://wizemory.com/tools/ai-note-taking' },
}
  ...
  return (
    <div className="min-h-screen bg-ink-50">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-lg text-ink-500 mb-10">Stop taking notes that you never read again. WizeMory AI turns every note into searchable, connected knowledge.</p>
